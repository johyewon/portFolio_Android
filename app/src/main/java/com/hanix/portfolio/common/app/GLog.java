...
public class GLog {
    ...
    public static synchronized void i (String msg) {
        if(GlobalApplication.getInstance().isDebuggable) dLong(msg, 1);
    }

    public static synchronized void d (String msg) {
        if(GlobalApplication.getInstance().isDebuggable) dLong(msg, 2);
    }

    public static synchronized void e (String msg) {
        if(GlobalApplication.getInstance().isDebuggable) dLong(msg, 3);
    }

    public static void e (String msg, Exception e) {
        if(GlobalApplication.getInstance().isDebuggable) Log.e(AppConstants.TAG, msg, e);
    }
